...
const QMetaObject moveit_rviz_plugin::ProgressBarWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__ProgressBarWidget.data,
      qt_meta_data_moveit_rviz_plugin__ProgressBarWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void moveit_rviz_plugin::ControlTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ControlTabWidget *_t = static_cast<ControlTabWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ControlTabWidget::*_t)(double , double , double , double , double , double );
...
const QMetaObject moveit_rviz_plugin::ControlTabWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__ControlTabWidget.data,
      qt_meta_data_moveit_rviz_plugin__ControlTabWidget,  qt_static_metacall, nullptr, nullptr}
};
