...
#include "../../../../../../src/moveit_calibration/moveit_calibration_gui/handeye_calibration_rviz_plugin/include/moveit/handeye_calibration_rviz_plugin/handeye_context_widget.h"
...
const QMetaObject moveit_rviz_plugin::TFFrameNameComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__TFFrameNameComboBox.data,
      qt_meta_data_moveit_rviz_plugin__TFFrameNameComboBox,  qt_static_metacall, nullptr, nullptr}
};
...
void moveit_rviz_plugin::SliderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SliderWidget::*_t)(double );
...
const QMetaObject moveit_rviz_plugin::SliderWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__SliderWidget.data,
      qt_meta_data_moveit_rviz_plugin__SliderWidget,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ContextTabWidget *_t = static_cast<ContextTabWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ContextTabWidget::*_t)(int );
        ...
        {
            typedef void (ContextTabWidget::*_t)(std::map<std::string,std::string> );
...
const QMetaObject moveit_rviz_plugin::ContextTabWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__ContextTabWidget.data,
      qt_meta_data_moveit_rviz_plugin__ContextTabWidget,  qt_static_metacall, nullptr, nullptr}
};
